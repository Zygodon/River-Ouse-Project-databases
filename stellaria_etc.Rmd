...
d1 <- (the_data 
       ...
       %>% filter(frac >= 0.02))
```
Removing those accounting for less than 0.2% of the records leaves `r nrow(d1)` species.
...
```
This looks much more useful. Community is now available in the interactive part.
